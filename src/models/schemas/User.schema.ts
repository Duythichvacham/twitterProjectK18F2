...
//interface: định nghĩa kiểu dl - mô tả obj(có thể thiếu thông tin) - k định hình obj hoàn chỉnh
interface UserType {
  _id?: ObjectId // có sẵn trong mongodb
...
// class : tạo obj - phải có full thông tin
